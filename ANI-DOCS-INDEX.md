...
刚完成：Sprint 2（2026-05-20，Core API Alpha Freeze + VM/Container/GPU dev profile）
下一步入口：repo/CURRENT-SPRINT.md
```

Sprint 3 的核心任务是在 Core API Alpha 已冻结的基础上，扩充网络、存储、向量、Workload Identity 与 SDK Alpha 能力。
...
4. `ANI-06-开发计划.md` Section 零和 Sprint 3
