...
Sprint 13 计划：真实 provider / live gate 计划见 repo/development-records/sprint13-real-provider-readiness-plan.md；SPRINT13-STORAGE-ROOK-CEPH-A-TRACK / validate-storage-live-gate 固定 Rook-Ceph storage snapshot 与 mount-target contract 门禁；未跑通 live gate 前不得标 runtime/production ready
