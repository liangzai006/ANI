...
Sprint 14 分支态：feature/sprint14-core-resilience-semantics 已完成 Core resilience R-P0-0..R-P2-7 local/logic 批次；MinIO/Milvus endpoint list fallback 已本地验证；真实故障注入、primary kill、HA topology failover 与 evidence JSON 未执行，不标 production ready。
