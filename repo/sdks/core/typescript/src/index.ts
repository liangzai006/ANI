...
export const paths = [
  ...
  "GET /networks/load-balancers/{load_balancer_id}/backend-groups",
  "POST /networks/load-balancers/{load_balancer_id}/backend-groups",
  "DELETE /networks/load-balancers/{load_balancer_id}/backend-groups/{backend_group_id}",
  "GET /networks/load-balancers/{load_balancer_id}/backend-groups/{backend_group_id}",
  "PUT /networks/load-balancers/{load_balancer_id}/backend-groups/{backend_group_id}",
  "GET /networks/load-balancers/{load_balancer_id}/backend-groups/{backend_group_id}/members",
  "POST /networks/load-balancers/{load_balancer_id}/backend-groups/{backend_group_id}/members",
  "DELETE /networks/load-balancers/{load_balancer_id}/backend-groups/{backend_group_id}/members/{member_id}",
  "GET /networks/load-balancers/{load_balancer_id}/backend-groups/{backend_group_id}/members/{member_id}",
  "PUT /networks/load-balancers/{load_balancer_id}/backend-groups/{backend_group_id}/members/{member_id}",
  "GET /networks/load-balancers/{load_balancer_id}/listeners",
  "POST /networks/load-balancers/{load_balancer_id}/listeners",
  "DELETE /networks/load-balancers/{load_balancer_id}/listeners/{listener_id}",
  "GET /networks/load-balancers/{load_balancer_id}/listeners/{listener_id}",
  "PUT /networks/load-balancers/{load_balancer_id}/listeners/{listener_id}",
...
export const schemas = [
  ...
  "NetworkLoadBalancerBackendMemberTargetType",
