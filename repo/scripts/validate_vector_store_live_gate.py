...
def main() -> int:
    ...
    validate_docs()
    if args.live:
        fail("--live is human-gated for SPRINT13-VECTOR-MILVUS-A and is not automated in A-track")
    print("SPRINT13-VECTOR-MILVUS-A contract valid; live execution is human-gated")
    return 0
