...
S01 **网络路由 Kube-OVN**、S02 **K8s workloads vCluster**、S03 **storage Rook-Ceph**、S04 **GPU NVIDIA device-plugin/DCGM** 与 S05 **object-store MinIO pre-signed URL** 已完成 A 轨 code+contract ready，真实 live gate 仍为 LIVE PENDING；就绪声明见 [`sprint13-netroute-kubeovn-readiness.md`](sprint13-netroute-kubeovn-readiness.md)、[`sprint13-k8s-workloads-vcluster-readiness.md`](sprint13-k8s-workloads-vcluster-readiness.md)、[`sprint13-storage-rook-ceph-readiness.md`](sprint13-storage-rook-ceph-readiness.md)、[`sprint13-gpu-inventory-dcgm-readiness.md`](sprint13-gpu-inventory-dcgm-readiness.md)、[`sprint13-objectstore-minio-readiness.md`](sprint13-objectstore-minio-readiness.md)，A 轨记录见 [`sprint13-netroute-kubeovn-a-track.md`](sprint13-netroute-kubeovn-a-track.md)、[`sprint13-k8s-workloads-vcluster-a-track.md`](sprint13-k8s-workloads-vcluster-a-track.md)、[`sprint13-storage-rook-ceph-a-track.md`](sprint13-storage-rook-ceph-a-track.md)、[`sprint13-gpu-inventory-dcgm-a-track.md`](sprint13-gpu-inventory-dcgm-a-track.md)、[`sprint13-objectstore-minio-a-track.md`](sprint13-objectstore-minio-a-track.md)。
