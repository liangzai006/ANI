...
| # | 切片 | 真实组件（已选） | status |
|---|---|---|---|
| S01 | 网络路由 | Kube-OVN v1.15.8 | pending（readiness 已建：`sprint13-netroute-kubeovn-readiness.md`） |
| S02 | K8s workloads | vCluster / K8s v1.36.1 | pending |
| S03 | 卷快照 / mount-targets | Rook-Ceph（CSI snapshot / RBD / NFS） | pending |
